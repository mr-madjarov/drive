 ...
 *
 * The followings are provided by scopes
 *
 * @method ConfigGroup counters()
 */
class ConfigGroup extends ActiveRecord
{
    const TYPE_FIRM = 'firm';
    const TYPE_EMAIL = 'email';
    const TYPE_COUNT = 'counter';
    /**
    ...
    public function relations()
    {
        ...
        return array(
            'fieldConfigs' => array( self::HAS_MANY, 'FieldConfig', 'config_group_id', 'index' => 'id' ),
        );
    }
    ...
    public function scopes()
    {
        return array(
            'counters' => array(
                'condition' => "type='" . ConfigGroup::TYPE_COUNT . "'",
                'with' => array(
                    'fieldConfigs' => array(
                        'together' => true,
                        'index' => 'name'
